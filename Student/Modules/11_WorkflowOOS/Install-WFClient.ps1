...
& 'C:\Program Files\Microsoft\Web Platform Installer\WebpiCmd.exe' /Install  /AcceptEula /Products:WorkflowClient /XML:\\wingtipapps\c$\WorkflowManagerFiles\feeds\latest\webproductlist.xml /SuppressPostFinish
